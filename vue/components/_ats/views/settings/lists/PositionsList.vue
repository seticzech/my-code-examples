  ...
  <div>
    <b-row align="end">
      <b-col class="col-auto mr-auto">
        <b-checkbox id="cb-positions-deleted" v-model="deleted" switch>
    ...
    <SimpleFieldTranslationsForm ref="sftf-positions" @save="onTranslationsFormSave"/>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...sync(store.namespace.ats.positions, ['deleted']),
    },
    methods: {
      ...call(store.namespace.ats.positions, ['itemAppend', 'itemDelete', 'itemsRefresh', 'itemRestore', 'itemUpdate']),
      addItem () {
        this.editedItem = null;

        this.$refs['sftf-positions'].show(null, this.$i18n.t('_ats.dialog.title_position_add'));
      },
      editItem (item) {
        this.editedItem = item;

        this.$refs['sftf-positions'].show(item.translations.name, this.$i18n.t('_ats.dialog.title_position_edit'));
      },
