...
<!--      </b-col>-->
      <b-col class="col-auto">
        ...
        <b-button class="ml-3" variant="stack-overflow" @click="addItem" :disabled="denied('post', 'regions')">
    ...
    <RegionForm @save="onFormSave"></RegionForm>
...
<script>
  ...
  import RegionForm from '@/components/modals/forms/RegionForm'
  ...
  export default {
    ...
    computed: {
      ...get(store.namespace.regions, ['items', 'loading']),
      ...sync(store.namespace.regions, ['deleted'])
    },
    methods: {
      ...call(store.namespace.regionForm, ['showRegionAdd', 'showRegionEdit']),
      ...call(store.namespace.regions, ['itemAppend', 'itemsLoad', 'itemsRefresh', 'itemUpdate']),
      addItem () {
